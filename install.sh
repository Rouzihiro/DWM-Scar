...
# List of programs
programs=( cava devour exa tty-clock-bin picom-simpleanims-next-bin cmatrix-bin pipes.sh npm \
    checkupdates-with-aur xdotool xautolock betterlockscreen yad libnotify pywalfox xsettingsd \
    themix-gui-bin themix-theme-oomox-bin archdroid-icon-theme tesseract-data-eng slop arandr \
    ...
    tree ttf-jetbrains-mono-nerd ttf-font-awesome gpick ueberzugpp redshift p7zip unzip epub-thumbnailer-bin \
